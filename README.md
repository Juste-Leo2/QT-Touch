...
L'objectif final est d'intégrer ces retours tactiles au projet [QTRobot-brain](https://github.com/Juste-Leo2/QTRobot-Brain) afin d'enrichir les interactions entre le LLM et l'utilisateur.
...
<p align="center">
  <img src="docs/loss_curve.png" alt="Courbe d'apprentissage" width="500">
</p>
...
<p align="center">
  <img src="docs/confusion_matrix.png" alt="Matrice de confusion" width="500">
</p>
...
*   **Pour l'inférence sur Raspberry Pi** :
    Consultez le [Guide d'inférence spécifique](raspberry_inference/README.md).
...
*   **Contribution IA** : La mise en place du code et l'optimisation ont été réalisées avec l'aide de modèles de langage (Gemini).
